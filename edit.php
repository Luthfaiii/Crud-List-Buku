        ...
        <form action="process.php" method="post">
            ...
            <div class="form-elemnt my-4">
                <select name="type" id="" class="form-control">
                    ...
                    <option value="Adventure" <?php if($row["type"]=="Adventure"){echo "selected";} ?>>Petualangan</option>
                    <option value="Crime" <?php if($row["type"]=="Crime"){echo "selected";} ?>>Komedi</option>
                    <option value="Fantasy" <?php if($row["type"]=="Fantasy"){echo "selected";} ?>>Novel</option>
